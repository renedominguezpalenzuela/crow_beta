...
use App\Controller\API\CreateNewUser;
...
class APIMoveTroopsController extends AbstractController
{
    ...
    public function move_troops(Request $request)
    {
         ...
         $usuario = New CreateNewUser();
         $usuario->PrintMessage("Hola");
     ...
     /**
     * @Route("/add_test_troops", name="add_test_troops")
     */
    public function add_test_troops(Request $request){
        //ad
