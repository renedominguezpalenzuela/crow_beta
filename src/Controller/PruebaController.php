    ...
    public function list_user_resources(Request $request)
    {
        ...
        foreach ($buildings as $unbuilding) {
            ...
            if ($building_type->getName() != 'Castle') {
                ...
                foreach ($unbuilding->getTroopBuildings() as $troopLocation){
                    $troopLocations [] = ['troop_id' => $troopLocation->getId(), 'troop_name' => $troopLocation->getTroops()->getUnitType()->getName(), 'total' => $troopLocation->getTotal()];
                }
                ...
                $arreglo[] = array(
                    ...
                    'troop_locations' => $troopLocations
                );
            }
